...
import com.example.chatappnative.composables.ButtonWithoutOuterPadding
import com.example.chatappnative.composables.LargeTopSection
import com.example.chatappnative.composables.ObserverAsEvent
import com.example.chatappnative.composables.PasswordInput
...
class RegisterActivity : ComponentActivity() {
    ...
    fun RegisterScreen(
        ...
        val channelFlow = registerModel.navigateChannelFlow

        ObserverAsEvent(channelFlow) {
            when (it) {
                NavigateRegisterScreen.Main -> {
