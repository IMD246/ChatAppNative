package com.example.chatappnative.gateway.local_database
...
class Preferences(context: Context) {
    ...
    fun saveUserInfo(value: UserInfoEntity) {
    ...
    fun getUserInfo(): UserInfoEntity? {
        ...
        return Gson().fromJson(toJsonUserInfo, UserInfoEntity::class.java)
    }
